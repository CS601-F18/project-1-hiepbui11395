...
public class AmazonSearch {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Utils.addToIndex(args[1], products, reviewIndex, TYPE.REVIEW);
			Utils.addToIndex(args[3], products, qaIndex, TYPE.QA);
			...
			Utils.executeCommand(reviewIndex, qaIndex, products);
		} catch (IOException e) {
